 ...
 */
public class EntriesTable implements BaseColumns {
    public static final String TABLE_NAME = "FeedEntries";

    public static final String ENTRY_TITLE_COLUMN = "title";
    public static final String ENTRY_DESCRIPTION_COLUMN = "description";
    public static final String ENTRY_URL_COLUMN = "url";
    public static final String ENTRY_PUBDATE_COLUMN = "pubdate";
    ...
    public static void onCreate(SQLiteDatabase db) {
        String DB_CREATE = "CREATE TABLE if not exists " + TABLE_NAME + " ( " +
                ...
                ENTRY_DESCRIPTION_COLUMN + " text not null, " +
                ENTRY_URL_COLUMN + " text not null, " +
                ENTRY_PUBDATE_COLUMN + " integer, " +
